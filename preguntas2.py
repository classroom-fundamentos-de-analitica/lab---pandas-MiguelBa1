...
def pregunta_06():
    ...
    salida = sorted(map(lambda x: x.upper(), valores))
    return salida
...
def pregunta_10():
    ...
    """
    salida = tbl0.groupby("_c1")["_c2"].apply(lambda x: list(x))
    salida = (pd.DataFrame(salida))
    salida["_c2"] = salida["_c2"].apply(lambda x : list(map(str, sorted(x))))
    salida["_c2"] = salida["_c2"].apply(lambda x : ":".join(x))
    return salida
...
def pregunta_11():
    ...
    39   39    a,d,f
    """
    valores = tbl1.groupby(['_c0'])['_c4'].apply(list)
    c0 = tbl1['_c0'].unique()
    c4 = []
...
def pregunta_12():
    ...
    """
    c5a = tbl2.groupby(['_c0'])['_c5a'].apply(list)
    c5b = tbl2.groupby(['_c0'])['_c5b'].apply(list)
    c0 = tbl1['_c0'].unique()
